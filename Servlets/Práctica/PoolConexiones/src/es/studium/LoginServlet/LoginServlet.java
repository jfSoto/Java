		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					out.println("<a href='logout'><button class='btn btn-primary'>Logout</button></a>");
					out.println("<a href='Libros.jsp'><button class='btn btn-primary'>Libros</button></a>");
					out.println("<a href='Pedidos.jsp'><button class='btn btn-primary'>Pedidos</button></a>");
				}
			}
			out.println("</body>");
			out.println("</html>");
