...
{
	String usuario = null;
	ModeloConsultaCliente(String usuario)
	{
	...
	public void Consulta() 
	{
		...
		try
		{
			...
			documento.open();
			PdfPTable consultaClientes = new PdfPTable(4);
			consultaClientes.addCell("Número del Cliente");
			consultaClientes.addCell("Nombre del Cliente");
			consultaClientes.addCell("Apellidos del Cliente");
			consultaClientes.addCell("Teléfono del Cliente");
			while(rs.next())
			{
				consulta = Integer.toString(rs.getInt("idCliente"));
				consulta = consulta + "-" + rs.getString("nombreCliente");
				consulta = consulta + "-" + rs.getString("apellidosCliente");
				consulta = consulta + "-" + Integer.toString(rs.getInt("telefonoCliente"));
