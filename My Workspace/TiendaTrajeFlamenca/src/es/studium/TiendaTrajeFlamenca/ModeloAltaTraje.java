...
public class ModeloAltaTraje
{
	String usuario = null;
	ModeloAltaTraje(String usuario)
	{
		this.usuario = usuario;
	}
	public void InsertarTraje(String tipoTraje, int tallaTraje, String fechaAdquisicionTrajeCliente, int idClienteFK1)
	{
		String driver = "com.mysql.jdbc.Driver";
		String url = "jdbc:mysql://localhost:3306/practica3trimestreprogramacion?useSSL=false";
		String login = "root";
		String password = "Studium2018;";
		String sentencia = "INSERT INTO Trajes(tipoTraje, tallaTraje, fechaAdquisicionTrajeCliente, idClienteFK1) VALUES('"+tipoTraje+"','"+tallaTraje+"',"
				+ "'"+fechaAdquisicionTrajeCliente+"','"+idClienteFK1+"')";
