...
public class ModeloBajaCosturera
{
	String usuario = null;
	ModeloBajaCosturera(String usuario)
	{
	...
	public void BorrarCosturera(int idCosturera)
	{
		String driver = "com.mysql.jdbc.Driver";
		String url = "jdbc:mysql://localhost:3306/practica3trimestreprogramacion?useSSL=false";
		String login = "root";
		String password = "Studium2018;";
		String sentencia = "DELETE FROM costureras where idCosturera =" + idCosturera;
		Connection connection = null;
		Statement statement = null;
		try
		{
