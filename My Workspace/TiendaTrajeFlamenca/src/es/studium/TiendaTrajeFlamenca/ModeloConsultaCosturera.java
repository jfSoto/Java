...
public class ModeloConsultaCosturera
{
	String usuario = null;
	ModeloConsultaCosturera(String usuario)
	{
	...
	public void Consulta() 
	{
		...
		try
		{
			...
			documento.open();
			PdfPTable consultaClientes = new PdfPTable(6);
			consultaClientes.addCell("Número de la Costurera");
			consultaClientes.addCell("Nombre de la Costurera");
			consultaClientes.addCell("Apellidos de la Costurera");
			consultaClientes.addCell("Teléfono de la Costurera");
			consultaClientes.addCell("DNI de la Costurera");
			consultaClientes.addCell("Dirección de la Costurera");
			while(rs.next())
			{
				consulta = Integer.toString(rs.getInt("idCosturera"));
				consulta = consulta + "-" + rs.getString("nombreCosturera");
				consulta = consulta + "-" + rs.getString("apellidosCosturera");
				consulta = consulta + "-" + Integer.toString(rs.getInt("telefonoCosturera"));
				consulta = consulta + "-" + rs.getString("dniCosturera");
				consulta = consulta + "-" + rs.getString("direccionCosturera");
				...
				String  ClientesTienda6 = ClientesTienda[5];
				...
				consultaClientes.addCell(ClientesTienda6);
			}
