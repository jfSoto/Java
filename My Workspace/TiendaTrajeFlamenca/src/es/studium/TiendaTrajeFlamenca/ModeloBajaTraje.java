...
public class ModeloBajaTraje
{
	String usuario = null;
	ModeloBajaTraje(String usuario)
	{
	...
	public void BorrarTraje(int idTraje)
	{
		String driver = "com.mysql.jdbc.Driver";
		String url = "jdbc:mysql://localhost:3306/practica3trimestreprogramacion?useSSL=false";
		String login = "root";
		String password = "Studium2018;";
		String sentencia = "DELETE FROM trajes where idTraje =" + idTraje;
		Connection connection = null;
		Statement statement = null;
		try
		{
