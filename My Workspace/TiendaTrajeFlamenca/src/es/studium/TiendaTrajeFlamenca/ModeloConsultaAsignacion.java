...
public class ModeloConsultaAsignacion
{
	String usuario = null;
	ModeloConsultaAsignacion(String usuario)
	{
	...
	public void Consulta() 
	{
		...
		try
		{
			...
			consultaClientes.addCell("Número de la Asignacion");
			consultaClientes.addCell("Número del Traje");
			consultaClientes.addCell("Número de la Costurera");
			consultaClientes.addCell("Fecha de Inicio de Fabricación");
			consultaClientes.addCell("Fecha de Fin de Fabricación");
			while(rs.next())
			{
				consulta = Integer.toString(rs.getInt("idAsignacion"));
				consulta = consulta + "/" + Integer.toString(rs.getInt("idTrajeFK2"));
				consulta = consulta + "/" + Integer.toString(rs.getInt("idCostureraFK3"));
				consulta = consulta + "/" + rs.getString("fechaInicioFabricacionTraje");
				consulta = consulta + "/" + rs.getString("fechaFinFabricacionTraje");
